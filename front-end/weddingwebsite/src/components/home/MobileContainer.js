        ...
        <Sidebar.Pushable>
          <Sidebar as={Menu} animation='uncover' inverted vertical visible={sidebarOpened}>
           ...
           <Menu.Item >
            ...
            <Menu.Item >
              <Link to="/gifting/registry" > Registry </Link>
            </Menu.Item>
            <Menu.Item >
              <Link to="/gifting/charity" > Charity </Link>
            </Menu.Item>
            <Menu.Item as='a' href="http://yokayoranch.com/" target="_blank">The Venue</Menu.Item>
            <Menu.Item as='a' href="http://www.vichysprings.com/" target="_blank">Vichy Hot Springs</Menu.Item>
