...
const HomepageLayout = ({ signInMessage, user }) => {
  ...
  return (
    <ResponsiveContainer signInMessage={signInMessage} >
      {user.loginStatus ? <UserDash /> : null}
          ...
          <Grid.Row>
            <Grid.Column width={9}>
              ...
              <p style={largeParagraphFont}>
                "It doesn’t interest me what you do for a living. I want to know what you ache for and if you dare to dream of meeting your heart’s longing. It doesn’t interest me how old you are. I want to know if you will risk looking like a fool for love, for your dream, for the adventure of being alive."            </p>
              <p style={{ fontSize: '1.13em' }}>-Oriah Mountain Dreamer, 'The Invitation'</p>
              <Header as='h3' style={{ fontSize: '2em' }}>
                We Make Da Love Magic
            </Header>
              <p style={largeParagraphFont}>
                Yes thats right, you thought it was the stuff of dreams, movies and general socialized peer pressure; but we really believe, in the magic we weave.</p>
              ...
              <Grid.Column width={4}>
                ...
                <List link inverted style={{ display: 'inline-block' }}>
                  ...
                  <List.Item >
                    ...
                    <List.Content style={{ textAlign: 'center' }}>
                      <a href="https://www.theonion.com/exciting-new-app-allows-users-to-be-pawns-in-26-year-ol-1819579504">World Domination Plans</a>
                    </List.Content>
                  </List.Item>
